...
app.get('/api/fellows', serveHeros);
app.get('/api/fellows/:id', serveHero);
app.post('/api/fellows', createHero);
app.patch('/api/fellows/:id', updateHero);
app.delete('/api/fellows/:id', deleteHero);
